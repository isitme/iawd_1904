...
<body>
    ...
    <section id="content">
        <div class="container">
            <div class="row">
                <div class="lab col-md-8 col-sm-12 col-12 pr-md-0">
                    <div class="row m-0">
                        ...
                        <div class="col-6 pr-md-0 p-0">
                            <div class="row m-0">
                                <div class="col-lg-4 col-6 p-0"><img class="img-fluid" src="images/lab1.jpg" alt=""></div>
                                <div class="col-lg-4 col-6 p-0"><img class="img-fluid" src="images/lab2.jpg" alt=""></div>
                                <div class="col-lg-4 col-6 p-0"><img class="img-fluid" src="images/lab3.jpg" alt=""></div>
                                <div class="col-lg-4 col-6 p-0"><img class="img-fluid" src="images/lab4.jpg" alt=""></div>
                                <div class="col-lg-4 col-6 p-0"><img class="img-fluid" src="images/lab5.jpg" alt=""></div>
                                <div class="col-lg-4 col-6 p-0"><img class="img-fluid" src="images/lab6.jpg" alt=""></div>
                            </div>
