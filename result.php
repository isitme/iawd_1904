                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse p-0" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="no-record.html">department</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="result">
                        ...
                        <div class="col-md-6 pl-0">
                            ...
                            <select name="" id="">
                                ...
                                <option class="opt" value="">select session</option>
                                <option class="opt" value="">fall</option>
                                <option class="opt" value="">spring</option>
                                <option class="opt" value="">summer</option>
                            </select>
                            <select name="" id="">
                               
                                <option class="opt" value="">select department</option>
                                <option class="opt" value="">fall</option>
                                <option class="opt" value="">spring</option>
                                <option class="opt" value="">summer</option>
                            </select>
                            <select name="" id="">
                                ...
                                <option class="opt" value="">select semester</option>
                                <option class="opt" value="">fall</option>
                                <option class="opt" value="">spring</option>
                                <option class="opt" value="">summer</option>
                            </select>
                            <select name="" id="">
                                ...
                                <option class="opt" value="">select shift</option>
                                <option class="opt" value="">fall</option>
                                <option class="opt" value="">spring</option>
                                <option class="opt" value="">summer</option>
                            </select>
