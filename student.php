            ...
            <div class="row">
                <div class="col-md-8 col-sm-12 col-12 pr-md-0">
                    <div class="row m-0">
                        ...
                        <div class=" teach student p-0">
                            <div class="col-12">
                                <form action="">
                                <select name="" id="">
                                    <option value="department">select department</option>
                                    <option value="department">web</option>
                                    <option value="department">design</option>
                                    <option value="department">dev</option>
                                </select>
                                <select name="" id="">
                            ...
                            <div class="tab-content">
                                <div id="computer" class="tab-pane fade in show active col-12 p-0" role="tabpanel" aria-labelledby="nav-computer-tab">
                                    <div class="row m-0">
