            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-11 col-sm-10">
                        <marquee>The latest news will be scrolled here. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy </marquee>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="row m-0">
                        ...
                        <div class="teach p-0">
                            <div class="col-12">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="computer-tab" data-toggle="tab" href="#computer" role="tab" aria-controls="computer" aria-selected="true">computer technology</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="electrical-tab" data-toggle="tab" href="#electrical" role="tab" aria-controls="electrical" aria-selected="false">electrical technology</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="mechanical-tab" data-toggle="tab" href="#mechanical" role="tab" aria-controls="mechanical" aria-selected="false">mechanical technology</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="civil-tab" data-toggle="tab" href="#civil" role="tab" aria-controls="civil" aria-selected="false">civil technology</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="electronics-tab" data-toggle="tab" href="#electronics" role="tab" aria-controls="electronics" aria-selected="false">electronics technology</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="electro-tab" data-toggle="tab" href="#electro" role="tab" aria-controls="electro" aria-selected="false">electro medical technology</a>
                                </li>
                            </ul>
                            </div>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="computer" role="tabpanel" aria-labelledby="computer-tab">
                                    <div class="row m-0">
                                        <div class="col-12 teacha">
                                            <div class="row m-0">
                                                <div class="col-4 p-0">
                                                    <img class="img-fluid" src="images/t-1.jpg" alt="">
                                                </div>
                                                <div class="col-7 offset-1">
                                                    <ul>
                                                        <li>Name : Md. Mahfuzur Rahman</li>
                                                        <li>Department : Computer Technology</li>
                                                        <li>Designation :instractor</li>
                                                        <li>Phone : +880-1112223334</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 teacha">
                                            <div class="row m-0">
                                                <div class="col-4 p-0">
                                                    <img class="img-fluid" src="images/t-2.jpg" alt="">
                                                </div>
                                                <div class="col-7 offset-1">
                                                    <ul>
                                                        <li>Name : Md. Mahfuzur Rahman</li>
                                        ...
                                        <div class="col-12 teacha">
                                            <div class="row m-0">
                                                <div class="col-4 p-0">
                                                    <img class="img-fluid" src="images/t-3.jpg" alt="">
                                                </div>
                                                <div class="col-7 offset-1">
                                                    <ul>
                                                        <li>Name : Md. Mahfuzur Rahman</li>
                                ...
                                <div class="tab-pane fade" id="electro" role="tabpanel" aria-labelledby="electro-tab">
                                    <div class="row m-0">
                                        <div class="col-12 teacha">
                                            <div class="row m-0">
                                                <div class="col-4 p-0">
                                    ...
                                    <div class="note col-md-12 col-sm-12 col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-11 col-sm-11 col-11 p-0 n">
                                                <h6 style="display: inline-block"><a href="notice.html" target="_blank"> Final Exam Changed Date of 1st, 2nd &amp; 3rd Semester.</a></h6>
                                                <p><a href="notice.html" target="_blank"><i class="fa fa-calendar"></i> 01-01-2018</a></p>
                                            </div>
                                        </div>
                                    </div>
